      ...
      <div className={styles.container}>
        ...
        <div className={styles.bottomSection}>
          ...
          <div className={styles.socialLinks}>
            ...
            <a href="https://www.youtube.com/@ZeroVitiligo" className={styles.socialLink} aria-label="YouTube" target="_blank"
              rel="noopener noreferrer">
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.instagram.com/zerovitiligo/" className={styles.socialLink} aria-label="Instagram" target="_blank"
              rel="noopener noreferrer">
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
